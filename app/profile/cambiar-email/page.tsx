...
import { requestEmailChangeAction, ActionState } from '@/app/actions/changeEmail'
...
export default function RequestEmailChangePage() {
  ...
  useEffect(() => {
    if (state?.success && state?.pendingEmail) {
      // Redirige a la vista común de verificación pasando los datos necesarios en la URL
    ...
    <div className="mx-auto max-w-xl p-4 sm:p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">
          Ingresa la nueva dirección donde deseas recibir el código de verificación.
        </p>
      </div>
